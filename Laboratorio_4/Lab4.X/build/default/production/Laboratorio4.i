...
isr: ;Rutina de interrupción
    btfsc ((INTCON) and 07Fh), 0 ;Revisa que interrupción esta realizando, con la bandera
...
config_reloj:
    ...
    bcf OSCCON,6
    bcf OSCCON,5
    bsf OSCCON,4 ;Frecuencia de 125kHz
...
config_tmr0_temporizador:
    ...
    ;movlw 134
    ;movf TMR0
    ;bcf ((INTCON) and 07Fh), 2 ;Si en caso esta encendida apaga la bandera
