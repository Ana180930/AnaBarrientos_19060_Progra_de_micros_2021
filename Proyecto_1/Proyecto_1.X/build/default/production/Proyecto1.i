...
t0_int:
    ...
    bsf flag_sel,0 ;Se pone en 1 cuando hay interrupción
    goto isr
...
seleccionar_displays:
    ...
    btfsc flag,5 ;Revisa si el display 5 está encendido
    goto display_7 ;Si está enciendida, se enciende display 1
    btfsc flag,6 ;Revisa si el display 5 está encendido
    goto display_8 ;Si está enciendida, se enciende display 1
    btfsc flag,7 ;Revisa si el display 5 está encendido
...
display_3:
    ...
    bsf flag,2 ;Enciende la bandera del display 3
    goto loop
...
display_4:
    ...
    bsf flag,3 ;Enciende la bandera del display 4
    goto loop
...
display_5:
    ...
    bsf flag,4 ;Enciende la bandera del display 5
    goto loop
...
display_6:
    ...
    bsf flag,5 ;Enciende la bandera del display 5
    goto loop
...
display_7:
    ...
    bsf flag,6 ;Enciende la bandera del display 5
    goto loop
...
display_8:
    ...
    bsf flag,7 ;Enciende la bandera del display 5
    goto loop
