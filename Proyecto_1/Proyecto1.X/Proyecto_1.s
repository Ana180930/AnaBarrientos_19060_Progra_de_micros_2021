...
seleccionar_displays:
    ...
    btfss bandera03, modo01
    goto configs
    bcf	    flag,flag_dis6	;Apaga la bandera del display 8
    bsf	    flag,flag_dis8	;Enciende la bandera del display 1
    goto loop
    configs:
