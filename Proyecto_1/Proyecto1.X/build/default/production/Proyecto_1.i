...
t1_int:
    ...
    ;Bandera status zero
    btfsc STATUS,2 ;Revisa la bandera de 2
    bsf flag_sel,2 ;Si esta encendida, enciende una bandera reset
    movlw 0xC2
...
main:
    ...
    bsf flag,0
    bsf bandera,0
    bsf bandera03,0 ;Enciende la bandera del modo 1
    call tiempos_vias
...
config_int_tmr0:
    ...
    bsf ((INTCON) and 07Fh), 3 ;Habilitar interrupción portb
    return
...
Botones:
    btfss bandera02,3 ;Revisa si la bandera 3 està encendida
...
;---------------------------Instrucciones 3 ----------------------------
    ...
    btfsc bandera03,1 ;Revisa si bandera modo 2 está encendia
    goto activar_modo03 ;Si está, va a activar modo 03
    btfsc bandera03,2 ;Revisa si bandera modo 3 está encendia
    goto activar_modo04 ;Si está, va a activar modo 04
    btfsc bandera02,6 ;Revisa si bandera modo 4 está encendia
    goto activar_modo05 ;Si está, va a activar modo 05
    btfsc bandera02,7 ;Revisa si bandera modo 5 está encendia
    ...
    bcf PORTB,5
    bcf PORTB,7
    bcf bandera02,7 ;Apaga bandera del modo 5
    bsf bandera03,0 ;Enciende bandera del modo 1
   ...
   activar_modo02:
    ...
    bcf bandera03,2 ;Apaga bandera modo 3
    bsf bandera02,6 ;Enciende bandera modo 4
    apagar_banderas
    goto fin_botones
    ...
    bcf bandera02,6
    bsf bandera02,7 ;Carga el valor a la variable dec
    apagar_banderas ;Apaga bandera modo 4
    goto fin_botones ;Enciende bandera modo 5

;---------------------------Incrementar variables ----------------------------
    boton_inc:
    btfss bandera02,5 ;revisa si se presionó y se soltó el botón incre.
    goto boton_dec
    btfss PORTB, 1
    goto boton_dec

;---------------------------------Instrucciones-------------------------------
    btfsc bandera03,1 ;Revisa si está activada la bandera modo 2
    goto incModo2 ;Si está activada, va a incrementar
    btfsc bandera03,2 ;Si no, revisa si está activada la bandera modo 3
    goto incModo3 ;Si está activada, va a incrementar
    btfsc bandera02,6 ;Si no, revisa si está activada la bandera modo 4
    goto incModo4 ;Si está activada, va a incrementar
    btfsc bandera02,7 ;Si no, revisa si está activada la bandera modo 5
    ...
    bcf bandera02,3 ;Apaga banderas
    bcf bandera02,5
    bcf bandera02,4
    goto fin_botones
...
;------------------------------------Reseteo----------------------------------
    ...
    movwf TV3
    bcf bandera02,7 ;Apaga el modo 5 y enciende la bandera modo 1
    bsf bandera03,0
...
;------------------------------Decrementar variables---------------------------
   boton_dec:
    btfss bandera02,4 ;Revisa si se presionó y soltó el boton decrementar
    goto fin_botones
    btfss PORTB, 1
    goto fin_botones
;---------------------------------Instrucciones-------------------------------
    btfsc bandera03,1 ;Revisa si la bandera del modo 2 está encendida
    goto decModo2 ;Si está encendida, va a decrementar modo 2
    btfsc bandera03,2 ;Si no, revisa si la bandera del modo 3 está enc.
    goto decModo3 ;Si está encendida, va a decrementar modo 3
    btfsc bandera02,6 ;Si no, revisa si la bandera del modo 4 está encend.
    goto decModo4 ;Si está encendida, va a decrementar modo 4
    btfsc bandera02,7 ;Si no, revisa si la bandera del modo 5 está enc.
    ...
    bcf PORTB,7
    bcf bandera02,7 ;Apaga la bandera modo 5
    bsf bandera03,0 ;Enciende la bandera modo 1
...
;----------------------------------Modos--------------------------------------
Revisa_modos:
    btfsc bandera03,0 ;Revisa si la bandera del modo 1 está encendida
    goto Modo_1 ;Si está encendida, va al modo 1
    btfsc bandera03,1 ;Si no, revisa la bandera del modo 2
    goto Modo_2 ;Si está encendida, va al modo 2
    btfsc bandera03,2 ;Si no, revisa la bandera del modo 3
    goto Modo_3 ;Si está encendida, va al modo 3
    btfsc bandera02,6 ;Si no, revisa la bandera del modo 4
    goto Modo_4 ;Si está encendida, va al modo 4
    btfsc bandera02,7 ;Si no, revisa la bandera del modo 5
...
tiempos_vias:
    ...
    bcf flag_sel,2 ;Clear en las banderas
    bcf bandera,3
    bcf bandera,6
    return
...
;Displays y leds v1 = verde (10 s), via 2 = rojo (10s), via 3 = rojo (20s)
    ...
    bsf bandera,3 ;Si llegó, enciende la bandera parpadeo
    btfsc bandera,3 ;Si no, revisa la bandera
    ...
    btfsc STATUS,2 ;Si llegó, enciende la bandera 6
    bsf bandera,6
    btfsc bandera,6 ;Si la bandera 6 está encendida
    goto amarillo_1 ;Va a 6, si no va a revisar 2 01

    revisar_cero01:
    movlw 0
    subwf var_dec1,W ;Revisa si el display llegó a 0
    btfsc STATUS,2 ;Si llegó, enciende la bandera de reset
    bsf flag_sel,2 ;Si no, revisa si la bandera reset esta encen.
    btfsc flag_sel,2 ;Si está encendida, va a resetear el display
    goto reset_1
...
Estado_02:
    ...
    verde_t02:
    btfsc flag_sel,3 ;Revisa si está encendida la bandera de paso
    goto cargar_valor ;Si está, va a revisar si llegó a 6 el 0 .
    goto fin_estados ;Si no, regresa al loop
    cargar_valor:
    movlw 6
    subwf var_dec2,w
    ...
    bsf bandera,6
    btfsc bandera,6 ;Si la bandera 6 está encendida
    goto amarillo_2 ;Va a 6, si no va a 2 02

    revisar_cero02:
    movlw 0
    subwf var_dec2,W ;Revisa si el display llegó a 0
    btfsc STATUS,2 ;Si llegó, enciende la bandera de reset
    bsf flag_sel,2 ;Si no, revisa si la bandera reset está encendi.
...
Estado_03:
    ...
    verde_t03:
    btfsc flag_sel,4 ;Revisa si está encendida la bandera de paso
    goto cargar_valor01 ;Si está, va a revisar si llegó a 6 el 0 .
    goto fin_estados ;Si no, regresa al loop
    cargar_valor01:
    movlw 6
    subwf var_dec3,w
    btfsc STATUS,2 ;Revisa si el display llegó a 6
    bsf bandera,5 ;Si llegó, enciende la bandera parpadeo
    btfsc bandera,5 ;Si no, revisa la bandera
    ...
    bsf bandera,6
    btfsc bandera,6 ;Si la bandera 6 está encendida
    goto amarillo_3 ;Va a 6, si no regresa
    ...
    btfsc STATUS,2 ;Si llegó, enciende la bandera de reset
    bsf flag_sel,2 ;Si no, revisa si la bandera reset está encendi.
    btfsc flag_sel,2 ;Si está encendida, va a reset 3
    goto reset_3
...
verde_parpadeo_1:
    ...
    bcf PORTD,2
    fin_subrutina01:
    goto revisar_amarillo01 ;Regresa a 6 01
...
amarillo_1:
    ...
    movwf PORTD
    bcf bandera,6 ;Apaga la bandera de 6, via 1
    goto revisar_cero01 ;Regresa a 2 01
...
verde_parpadeo_2:
    btfsc bandera02,1 ;Revisa la bandera parpadeo de la interrup.
    ...
    bcf PORTD,5
    fin_subrutina02:
    goto revisar_amarillo02 ;Regresa a 6 02
...
verde_parpadeo_3:
    btfsc bandera02,2 ;Revisa la bandera parpadeo de la interrup.
    ...
    bcf PORTE,0
    fin_subrutina03:
    goto revisar_amarillo03 ;Regresa a 6 02

amarillo_3:
    bcf bandera,5 ;Apaga la bandera de verde titilante
    bcf PORTE,0 ;Apaga la led verde titilante de la via 3
    movlw 10001001B ;Enciende la led amarilla, vía 3
    movwf PORTD
    bcf bandera,6 ;Apaga la bandera de 6
    goto revisar_cero03 ;Regresa a 2 03
...
seleccionar_displays:
    ...
    btfsc flag,7 ;Revisa si el display 8 está encendido
    ...
    btfsc flag,2 ;Revisa si el display 3 está encendido
    goto display_4 ;si está encendido,se enciende display 4
    btfsc flag,3 ;Revisa si el display 4 está encendido
...
display_2:
    ...
    bsf flag,1 ;Enciende la bandera display 2
    goto loop
...
display_3:
    ...
    bsf flag,2 ;Enciende la bandera display 3
    goto loop
...
display_4:
    ...
    bsf flag,3 ;Enciende la bandera display 4
    goto loop
...
display_5:
    ...
    bsf flag,4 ;Enciende la bandera display 5
    goto loop
...
display_6:
    ...
    bsf flag,5 ;Enciende la bandera display 6
    goto loop

display_7:
    movf var_display_7,W ;Mover variable cargada a W
    movwf PORTC ;Cargamos el valor al puerto c
    btfsc bandera03,0 ;Si el display está en el modo 1, lo apaga
    goto apagar_gris01
    ...
    paso_banderas01:
    bcf flag,5 ;Apaga la bandera del display 6
    bsf flag,6 ;Enciende la bandera display 7
    goto loop
...
display_8:
    ...
    paso_banderas02:
    bcf flag,6 ;Apaga la bandera del display 7
    bsf flag,7 ;Enciende la bandera display 8
    goto loop
