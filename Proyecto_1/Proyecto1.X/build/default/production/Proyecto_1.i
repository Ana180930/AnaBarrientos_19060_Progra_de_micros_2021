...
;Displays y leds v1 = verde (10 s), via 2 = rojo (10s), via 3 = rojo (20s)
    ...
    bcf flag_sel,2 ;esto va en el estado 3
    bcf bandera,3
    bcf bandera,6
    ;movlw 01001100B ;Verde v1, rojo v2, rojo v3
    ;movwf PORTD
    ...
    goto amarillo_1 ;Va a 6, si no regresa
...
Estado_02:
    ...
    bsf bandera,6
    btfsc bandera,6 ;Si la bandera 6 está encendida
    goto amarillo_2 ;Va a 6, si no regresa
...
verde_parpadeo_2:
    btfsc bandera02,1 ;Revisa la bandera parpadeo de la interrupcion
...
verde_parpadeo_3:
    btfsc bandera02,2 ;Revisa la bandera parpadeo de la interrupcion
