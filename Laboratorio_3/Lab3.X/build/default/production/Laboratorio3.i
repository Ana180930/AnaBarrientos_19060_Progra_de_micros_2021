...
config_tmr0_temporizador: ;Configuración del TMR0 como temporizador
    banksel OPTION_REG
    bcf ((OPTION_REG) and 07Fh), 5 ;Reloj interno para el temporizador
    bcf ((OPTION_REG) and 07Fh), 3 ;Prescaler para el tmr0
    bsf ((OPTION_REG) and 07Fh), 2 ;Prescaler de 256 (1 1 1)
...
antirebote:
    ...
    call display_7_incr
    btfsc PORTB,1 ;Revisa si hay un 1 o un 0 en el pin 0
    call display_7_decr
